    ...
    return (
        <>
            ...
            <div className={style.contact_wrap}>
                <div className={`wrap ${style.contact_box}`}>
                    {/* 정보 */}
                    <div className={style.left}>
                        ...
                        <div>
                            ...
                            <p>EMAIL</p>
                            <a href={'mailto:tjsgp1401@naver.com'}>
                                tjsgp1401@ <br />
                                naver.com
                            </a>
                        </div>
                    ...
                    >
                        ...
                        <div className={style.row}>
                            <p className={style.essential}>감사합니다 :)</p>
                            <p className={style.error_message}>
                                <span>
                                    {errors.compNm && errors.compNm.message}
                                </span>
                                <span>{errors.pn && errors.pn.message}</span>
                                <span>
